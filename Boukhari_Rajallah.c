...
// To create the binary file, please use the command     gcc Boukhari_Rajallah.c -lreadline    
...
char* getDirectoryPrompt(){
	...
	// get current working directory and format it like a default shell prompt
	getcwd(cwd, sizeof(cwd));
	strcpy(temp, "\n");
	directory = strcat(strcat(temp, cwd),"$ ");
...
{ 	
	...
	strLine = readline(getDirectoryPrompt()); 
